...
def load_encodings(path_dataset):
    ...
    for subdir in subdirs:
        ...
        for image_path in images_list:
            ...
            # Get encoding
            face_roi = face_recognition.face_locations(img, model="hog")  # cnn or hog

            # only to display onc ell output
            ...
            if (len(img_encoding) > 0):
                ...
                print("Couldn't encode face from image => {}".format(
                    image_path))  # probably because couldn't find any face on the image
